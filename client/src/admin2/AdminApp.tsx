...
import { SidebarNav } from "./SidebarNav"; // Assuming you put the component here
import Dashboard from "./Dashboard";
import RagUploader from "./RagUploader";
import UserInbox from "./UserInbox";
import QueryTable from "./QueryTable";
import { Separator } from "@/components/ui/separator"; // A common shadcn/ui utility component
import { LogOut, Home } from "lucide-react"; // Icon for logout/footer

export default function AdminApp() {
    return (
        <BrowserRouter>
            {/* The main container uses a fixed sidebar layout */}
            <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950">
                ...
                <main className="flex-1 ml-64 p-6 overflow-auto">
                    <Routes>
                        ...
                        {/* Add a redirect route for the base /admin path if needed */}
