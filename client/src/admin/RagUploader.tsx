...
export default function RAGUploader() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.info("Document Removed", {
        description:
          "The knowledge document has been removed from the RAG index.",
        duration: 3000,
        icon: "🗑️",
      });
    },
  ...
  const handleDelete = (docId: string) => {
    ...
    toast.warning("Confirm Deletion", {
      description:
        "Are you sure you want to delete this document? This will remove it from the RAG knowledge base.",
    ...
    <div className="p-6 space-y-8 bg-gray-50 dark:bg-gray-900 min-h-screen rounded-xl">
      <header className="space-y-2">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-lg">
          Manage the documents and content used by the AI assistant for
          contextual answers.
        </p>
      </header>
      ...
      <Tabs defaultValue="upload" className="w-full">
        ...
        >
          <div className="space-y-6">
            <h2
              className={`text-2xl font-bold border-b pb-3 ${FUCHSIA_TEXT_CLASS}`}
            >
              Paste Document or Text
            </h2>
            ...
            <div className="flex justify-between items-center pt-4">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                This process vectorizes the text for the AI's knowledge base and
                may take a few moments.
              </p>
              <Button
                onClick={handleUpload}
                disabled={
                  uploadMutation.isPending || !title.trim() || !text.trim()
                }
        ...
        >
          <h2
            className={`text-2xl font-bold mb-6 border-b pb-3 ${FUCHSIA_TEXT_CLASS}`}
          >
          ...
          {!isLoading && docs.length === 0 && !error && (
            <div className="text-center text-gray-500 py-12 border border-dashed rounded-lg dark:border-gray-700">
              ...
              <p>
                No documents have been indexed yet. Start by adding content.
              </p>
            </div>
          )}
