  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-500 dark:text-gray-400">
        Manage the documents and content used by the AI assistant for contextual
        answers.
      </p>
        ...
        >
          ...
          {isLoading && (
            <div className="flex items-center justify-center h-40 text-fuchsia-600">
              <Loader2 className="mr-2 h-6 w-6 animate-spin" /> Loading document
              list...
            </div>
          )}
          ...
          {!isLoading && docs.length === 0 && !error && (
            <p className="text-center text-gray-500 py-10 border rounded-lg dark:border-gray-700">
              No documents have been indexed yet. Start by adding content in the
              'Add New Content' tab.
            </p>
          )}
          ...
          {!isLoading && docs.length > 0 && (
            <Table>
              ...
              <TableCaption className="dark:text-gray-400">
                A list of all indexed RAG documents.
              </TableCaption>
            </Table>
          )}
        </TabsContent>
