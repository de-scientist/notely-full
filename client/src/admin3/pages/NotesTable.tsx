...
const MOCK_NOTES: Note[] = [
  {
    ...
    synopsis:
      "Key takeaways and next steps from the first team meeting on the new CMS system.",
    content:
  ...
  },
  {
    ...
    synopsis:
      "High-level overview of digital marketing campaigns and budget allocation for the next quarter.",
    content:
  ...
  },
  {
    ...
    synopsis:
      "Step-by-step procedure for moving production data to the new AWS RDS instance.",
    content:
  ...
  },
  {
    ...
    synopsis:
      "Summary of breaking changes in the /users endpoint (v2) implemented last week.",
    content:
  ...
  const filteredNotes = useMemo(() => {
    ...
    if (filterStatus !== "all") {
      ...
      filtered = filtered.filter(
        (note) => (note.isPublic ?? false) === targetPublic,
      );
    }
