...
import { Loader2, BookOpen, PenTool, FolderOpen, FilePenLine } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-6xl py-8 px-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="content" className="flex items-center gap-2">
                  <BookOpen className="h-4 w-4" /> Content (Markdown Supported)
                </Label>
                <Textarea
                  id="content"
                  rows={15}
              ...
              <Button type="submit" disabled={mutation.isPending || isLoadingCategories} className={`w-full text-lg font-semibold ${GRADIENT_BUTTON_CLASS}`}>
                {mutation.isPending ? (
                  <>
        ...
        {/* LIVE PREVIEW */}
        <Card className="dark:bg-gray-900 lg:sticky lg:top-8 h-fit shadow-md">
          <CardHeader>
