      ...
      <Card className="dark:bg-gray-900/70 shadow-lg space-y-8">
        ...
        <CardContent>
          <p className="text-gray-700 dark:text-gray-300">
            By accessing and using the **Notely App**, you agree to be bound by
        ...
        <CardContent className="space-y-6">
          ...
          <ul className="list-disc ml-6 space-y-3 text-gray-700 dark:text-gray-300">
            ...
            <li>
              <span className="font-semibold">Responsibility:</span> You are
              responsible for protecting your password and account activity.
            </li>
            <li>
              <span className="font-semibold">Accuracy:</span> You must provide
        ...
        <CardContent className="space-y-6">
          ...
          <ul className="list-disc ml-6 space-y-3 text-gray-700 dark:text-gray-300">
            <li>
              <span className="font-semibold">Ownership:</span> You retain all
              ownership rights to your content (notes, categories).
            </li>
            <li>
              <span className="font-semibold">Prohibited Content:</span> You
              must not post or transmit any content that is illegal, harmful,
              abusive, or infringes on others' rights.
            </li>
          </ul>
        </CardContent>
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            The Notely App is provided on an **"as is"** basis. We make no
            warranties regarding the Service and disclaim all implied
            warranties, including merchantability and fitness for a particular
            purpose. We do not guarantee the service will be uninterrupted or
            error-free.
          </p>
        </CardContent>
      </Card>
