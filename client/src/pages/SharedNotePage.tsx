...
export function SharedNotePage() {
  ...
  const {
    ...
    queryFn: async (): Promise<SharedEntry> => {
      ...
      const response = await api.get<PublicEntryResponse>(
        `/public/entries/${id}`,
      );
  ...
  if (isError || !entry) {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8">
        ...
        <a href="/" className={`mt-6 ${PRIMARY_TEXT_CLASS} hover:underline`}>
          Go to Homepage
        </a>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      >
        <Card className="shadow-2xl bg-white dark:bg-gray-800 border-t-4 border-fuchsia-500 print:shadow-none">
